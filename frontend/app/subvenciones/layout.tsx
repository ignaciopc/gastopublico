...
export const metadata: Metadata = {
  ...
  description:
    'Buscador de subvenciones públicas del Estado español. Datos reales de la Base de Datos Nacional de Subvenciones (BDNS) del Ministerio de Hacienda. Filtra por beneficiario, organismo e importe.',
  keywords: [
  ...
  openGraph: {
    title: 'Subvenciones del Estado 2024 – Base de Datos BDNS',
    description: 'Buscador de subvenciones públicas del Estado español. Datos reales de la BDNS del Ministerio de Hacienda.',
  ...
  twitter: {
    ...
    title: 'Subvenciones del Estado 2024 – Base de Datos BDNS',
    description: 'Buscador de subvenciones públicas. Datos reales BDNS del Ministerio de Hacienda.',

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Alquiler +80% en 10 años, esfuerzo salarial de 8 años, 49.000 desahucios en 2023. Datos reales del Ministerio de Transportes e INE.',
  ...
  twitter: {
    ...
    description: 'Alquiler +80%, esfuerzo salarial 8 años de salario, 49.000 desahucios/año. Datos reales.',
